...
class DeviceInfoWidgetScreen extends StatefulWidget {
  @override
  _DeviceInfoWidgetScreenState createState() => _DeviceInfoWidgetScreenState();
}

class _DeviceInfoWidgetScreenState extends State<DeviceInfoWidgetScreen> {
